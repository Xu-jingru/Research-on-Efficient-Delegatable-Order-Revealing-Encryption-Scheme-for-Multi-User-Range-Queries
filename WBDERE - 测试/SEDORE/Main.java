...
public class Main {
	...
	public static void main(String[] args) throws NoSuchAlgorithmException {
		...
		Element mv_hash;
		mv_hash = pairing.getZr().newElementFromHash(temp, 0, temp.length);
		//hash encryption
		Enc enc = new Enc();
		Element[] ct_v = new Element[4];
		init.initDimensionOne_Zr(Zr, ct_v, 4);
		enc.encrypt(Zr, ct_v, mv_hash, sk_v);

		EncDB encDb = new EncDB();
		Element[][] ct_u1 = new Element[8000][4];
		init.initDimensionTwo_Zr(Zr, ct_u1, 8000,4);
		...
		Element[][] ct_u2 = new Element[8000][4];
		init.initDimensionTwo_Zr(Zr, ct_u2, 8000,4);
		...
		Element[][] ct_u3 = new Element[8000][4];
		init.initDimensionTwo_Zr(Zr, ct_u3, 8000,4);
		...
		Element[][] ct_u4 = new Element[8000][4];
		init.initDimensionTwo_Zr(Zr, ct_u4, 8000,4);
		...
		Element[][] ct_u5 = new Element[8000][4];
		init.initDimensionTwo_Zr(Zr, ct_u5, 8000,4);
