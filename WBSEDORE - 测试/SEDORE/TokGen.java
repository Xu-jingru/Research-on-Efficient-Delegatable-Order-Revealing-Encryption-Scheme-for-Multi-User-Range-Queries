...
public class TokGen {
	...
	public void authorize (Field<Element> Zr, Field<Element> G1, Element[] tk_v_to_u, Element[] sk_u, Element[] pk_v) throws NoSuchAlgorithmException {
		MessageDigest hasher = MessageDigest.getInstance("SHA-256");
		Element temp0 = G1.newElement();
		temp0.set(pk_v[0]);
